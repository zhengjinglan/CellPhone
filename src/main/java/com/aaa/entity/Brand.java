...
public class Brand implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getBrandId() == null ? other.getBrandId() == null : this.getBrandId().equals(other.getBrandId()))
            ...
            && (this.getBrandIcon() == null ? other.getBrandIcon() == null : this.getBrandIcon().equals(other.getBrandIcon()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBrandIcon() == null) ? 0 : getBrandIcon().hashCode());
