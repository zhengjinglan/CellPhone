...
public class Emp implements Serializable {
	...
	public boolean equals(Object that) {
		...
		Emp other = (Emp) that;
		return (this.getEmpId() == null ? other.getEmpId() == null : this
				.getEmpId().equals(other.getEmpId()))
				&& (this.getDeptId() == null ? other.getDeptId() == null : this
						.getDeptId().equals(other.getDeptId()))
				&& (this.getJobId() == null ? other.getJobId() == null : this
						.getJobId().equals(other.getJobId()))
				&& (this.getEmpName() == null ? other.getEmpName() == null
						: this.getEmpName().equals(other.getEmpName()))
				&& (this.getEmpSex() == null ? other.getEmpSex() == null : this
						.getEmpSex().equals(other.getEmpSex()))
				&& (this.getEmpPhone() == null ? other.getEmpPhone() == null
						: this.getEmpPhone().equals(other.getEmpPhone()))
				&& (this.getEmpAddress() == null ? other.getEmpAddress() == null
						: this.getEmpAddress().equals(other.getEmpAddress()))
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((getEmpName() == null) ? 0 : getEmpName().hashCode());
		result = prime * result
				+ ((getEmpSex() == null) ? 0 : getEmpSex().hashCode());
		result = prime * result
				+ ((getEmpPhone() == null) ? 0 : getEmpPhone().hashCode());
		result = prime * result
				+ ((getEmpAddress() == null) ? 0 : getEmpAddress().hashCode());
		result = prime * result
