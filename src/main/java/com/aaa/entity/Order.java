...
public class Order implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getOrderId() == null ? other.getOrderId() == null : this.getOrderId().equals(other.getOrderId()))
            ...
            && (this.getPredeterminedTime() == null ? other.getPredeterminedTime() == null : this.getPredeterminedTime().equals(other.getPredeterminedTime()))
            && (this.getRealBegin() == null ? other.getRealBegin() == null : this.getRealBegin().equals(other.getRealBegin()))
            ...
            && (this.getDiagnosisResult() == null ? other.getDiagnosisResult() == null : this.getDiagnosisResult().equals(other.getDiagnosisResult()))
            && (this.getRealSolution() == null ? other.getRealSolution() == null : this.getRealSolution().equals(other.getRealSolution()))
            && (this.getAddress() == null ? other.getAddress() == null : this.getAddress().equals(other.getAddress()))
            && (this.getColor() == null ? other.getColor() == null : this.getColor().equals(other.getColor()))
            && (this.getForecastPrice() == null ? other.getForecastPrice() == null : this.getForecastPrice().equals(other.getForecastPrice()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPredeterminedTime() == null) ? 0 : getPredeterminedTime().hashCode());
        result = prime * result + ((getRealBegin() == null) ? 0 : getRealBegin().hashCode());
        result = prime * result + ((getRealEnd() == null) ? 0 : getRealEnd().hashCode());
        result = prime * result + ((getAssignTime() == null) ? 0 : getAssignTime().hashCode());
        result = prime * result + ((getDiagnosisResult() == null) ? 0 : getDiagnosisResult().hashCode());
        result = prime * result + ((getRealSolution() == null) ? 0 : getRealSolution().hashCode());
        result = prime * result + ((getAddress() == null) ? 0 : getAddress().hashCode());
        result = prime * result + ((getColor() == null) ? 0 : getColor().hashCode());
        result = prime * result + ((getForecastPrice() == null) ? 0 : getForecastPrice().hashCode());
        return result;
    }
