...
<html lang="en">
<head>
<title>Land Investors a Real Estates Category Bootstrap Responsive Web Template | Contact :: w3layouts</title>
		...
		<div class="header-nav">
			<nav class="navbar navbar-default">
					<div class="navbar-header logo">
								...
								<h1>
									<a class="navbar-brand" href="index.html">Land Investors</a>
								</h1>
					</div>
					

<!-- contact -->
<div class="contact_agile">
	<div class="container">
