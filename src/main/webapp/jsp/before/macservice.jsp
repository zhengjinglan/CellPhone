        ...
        <div class="wrap">
            ...
            <form  id="biddingForm" >
                <div class="ksxdUpdate">
                    ...
                    <div class="table_div">
                        <div class="name">
                            <input type="text" placeholder="怎么称呼你" name="uname" id="uname" class="txt">
                        </div>
                        <div class="tel">
                            <input type="text" placeholder="填写能联系到您的电话" class="txt" id="phone" name="phone">
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        $(".guzhang").click(function () {
            ...
            if (colorId == null) {
                ...
                $.post(url + "orders/query", {tid: tid}, function (d) {//初始化故障大类
                            var data = JSON.parse(d);
                            var condata = data.malfunctionList;
                            var context = "";
                            if (condata != undefined) {
