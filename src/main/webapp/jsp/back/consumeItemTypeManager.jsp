	...
	<script type="text/javascript">
		...
		function dels(){
			...
			if(rows!=""){
				...
				console.log("删除编号"+ids);
				$.post("consumeItemType/dels",{"ids":ids.toString()},function(data){
					if(data==true){
						$.messager.show({
							title:'提示',
							msg:"删除成功！"
		...
		function submits(){
			...
			$.post(url,{"typeId":$("#typeId").val(),"typeName":$("#typeName").val(),"gmtCreate":$("#gmtCreate").val(),
