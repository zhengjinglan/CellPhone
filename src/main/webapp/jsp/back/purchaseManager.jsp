...
<html>
		...
		<form id="fm" method="post">
			<div style="margin-bottom: 20px">
				...
				<input class="easyui-textbox" style="width:100%" readonly="readonly"
					id="purchaseId" name="purchaseId" data-options="label:'采购编号:'" value="自动生成"/>
			</div>
			<div style="margin-bottom: 20px">
			...
			<div style="margin-bottom: 20px">
				<input class="easyui-textbox" 
					data-options="label:'采购总价:'" 
					style="width:100%"
					id="purchaseSum" name="purchaseSum" readonly="readonly"/>
			</div>
			<div style="margin-bottom: 20px">
  ...
  <script type="text/javascript" src="jsp/back/js/purchase.js"></script>
</html>
