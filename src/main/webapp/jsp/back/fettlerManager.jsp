...
<!-- 引入easyui -->
		...
		<form id="fm" method="post">
			<div style="margin-bottom: 20px">
				...
				<input class="easyui-textbox" style="width:100%" readonly="readonly"
					id="fettlerId" name="fettlerId" data-options="label:'维修工编号:'" value="自动生成"/>
			</div>	
			<div style="margin-bottom: 20px"> 
				<input class="easyui-textbox" data-options="label:'员工名称:'" style="width:100%"
					id="empId" name="empId" />
			</div>
  ...
  <script type="text/javascript" src="jsp/back/js/fettler.js"></script>
</html>
